let sobremim = [
    ...
    {
        "titulo": "Treinamentos realizados", "texto": "",
        "lista": [
...
let politicasdeprivacidade = {
    ...
    "Alterações na Política de Privacidade": "A política de privacidade pode ser atualizada de tempos em tempos e a versão mais recente estará sempre disponível no site F3lixTech.",
...
let politicas = new Vue({
    el: '#politicasdeprivacidade', data: {
